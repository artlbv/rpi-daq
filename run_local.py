...
if __name__ == "__main__":
    ...
    conf=yaml_config(options.yamlfname)
    ...
    if glb_options['storeYamlFile'] and not options.dataNotSaved:
        yamlFileName=glb_options['outputYamlPath']+"/Module_"+options.moduleNumber+"_"
    ...
    if not options.dataNotSaved:
        rawFileName=glb_options['outputRawDataPath']+"/Module_"+options.moduleNumber+"_"
